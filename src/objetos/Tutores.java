...
public class Tutores extends Pessoa {
    ...
    public Tutores(String nome, Date dataDeNascimento, char genero, String CPF, Endereco endereco, Telefone telefone, String email, String senha, String codigo, int animaisSobCustodia, List<Historico> historicoAdocoes, boolean status) {
    ...
    public Tutores(String nome, Date dataDeNascimento, char genero, String CPF, Endereco endereco, Telefone telefone, String email, String senha, String codigo, int animaisSobCustodia, boolean status) {
        super(nome, dataDeNascimento, genero, CPF, endereco, telefone, email, senha);
        this.codigo = codigo;
        this.animaisSobCustodia = animaisSobCustodia;
